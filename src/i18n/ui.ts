...
export const ui = {
  'en': {
    // Site Metadata
    'siteMetadata.title': 'Eoin Farrell',
    'siteMetadata.headerTitle': 'Eoin Farrell',   
    'siteMetadata.description': 'Astrophysics PhD & AI Researcher',
    'siteMetadata.language': 'en-US',

    // Pages
    'pages.home.latestPosts': 'Eoin Farrell',
    ...
    'pages.blog.description': 'All posts',
