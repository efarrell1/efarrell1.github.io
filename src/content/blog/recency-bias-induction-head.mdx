...
<Plot dataPath="/../src/figures/toy_transformer_experiments/position_of_second_a_token.json" height={500} width="95%" client:load>
...
<Plot dataPath="/../src/figures/toy_transformer_experiments/position_of_second_a_token_attention.json" height={500} width="95%" client:load>
...
<Plot dataPath="/../src/figures/toy_transformer_experiments/random_attention_pattern_ind_head_7.json" height={500} width="95%" client:load>
...
<Plot dataPath="/../src/figures/toy_transformer_experiments/random_attention_pattern_ind_head_48.json" height={500} width="95%" client:load>
...
<Plot dataPath="/../src/figures/toy_transformer_experiments/all_heads_ablated_except_l0h2.json" height={500} width="95%" client:load>
